...
namespace otcv {
	...
	static const char* _extension_names[] = { "VK_KHR_swapchain" };
	static const char** extension_names = _extension_names;

	static VkQueueFlagBits queue_required = VkQueueFlagBits(VK_QUEUE_GRAPHICS_BIT | VK_QUEUE_COMPUTE_BIT | VK_QUEUE_TRANSFER_BIT);

	static VkSurfaceFormatKHR surface_format = { VK_FORMAT_B8G8R8A8_UNORM , VK_COLOR_SPACE_SRGB_NONLINEAR_KHR };
